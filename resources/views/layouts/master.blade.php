...
<head>
    ...
    @stack('css_after')
    {{-- untuk menyisipkan sesuatu, mirip yield tapi lebih khusus seperti mengimport css --}}
</head>
...
<body>
 ...
 text-muted d-flex align-items-center menu-collapsed">
                ...
                {{-- Separator END --}}
                <a href="{{ route('movies.index') }}" class="bg-dark list-group-item list-group-item-action">
